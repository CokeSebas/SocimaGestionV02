...
public class SeguridadVendedor extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seguridad_vendedor);


        lock9View = (Lock9View) findViewById(R.id.lock_9_view);
        Titulo = (TextView) findViewById(R.id.Titulo);

        Nombre = (TextView) findViewById(R.id.NombreVendedor);
        ...
        Log.d("ClavePad1", "" + Usuario.getInt("Patron" + CodigoVendedor, 000));
                    ...
                    do {
                        lock9View.setCallBack(new Lock9View.CallBack() {
                            ...
                            public void onFinish(String password) {
                                ClaveUno = password;
                                if (!ClaveUno.equals("")) {
                                    new SweetAlertDialog(SeguridadVendedor.this)
                            ...
                            public void onFinish(String password) {
                                ...
                                if (!ClaveDos.equals("")) {
                                    if (ClaveUno.equals(ClaveDos)) {
                                        ...
                                        Log.d("ClavePad2", "" + Integer.parseInt(ClaveDos.toString()));
                                        EditarUsuario.apply();

                                        new SweetAlertDialog(SeguridadVendedor.this, SweetAlertDialog.SUCCESS_TYPE)
                                                ...
                                                .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                                                    ...
                                                    public void onClick(SweetAlertDialog sDialog) {
                                                        ...
                                                        Intent i = new Intent(SeguridadVendedor.this, SistemaVendedor.class);
                                                        startActivity(i);
                                        ...
                                        ClaveDos = "";
                                        new SweetAlertDialog(SeguridadVendedor.this, SweetAlertDialog.ERROR_TYPE)
                                                .setTitleText("Oops...")
                    ...
                    lock9View.setCallBack(new Lock9View.CallBack() {
                        ...
                        public void onFinish(String password) {
                            ...
                            if (Patron == Integer.parseInt(password.toString())) {
                                ...
                                new SweetAlertDialog(SeguridadVendedor.this, SweetAlertDialog.WARNING_TYPE)
                                        .setTitleText("Error!")
            ...
            BtnRecuperar.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (RecuperarClave.getText().toString().equals(Usuario.getString("Clave", ""))) {
                        ...
                        Intent i = new Intent(SeguridadVendedor.this, SeguridadVendedor.class);
                        startActivity(i);
                            ...
                            new SweetAlertDialog(SeguridadVendedor.this, SweetAlertDialog.ERROR_TYPE)
                                    ...
                                    .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                                        ...
                                        public void onClick(SweetAlertDialog sDialog) {
                                            ...
                                            sDialog.cancel();
                                            ClaseSistema.finish();
                                            Intent i = new Intent(SeguridadVendedor.this, Login.class);
